 ...
 */
 ...
 $is_visible = get_post_meta( $post->ID, $this->visibility_option, true );
 $is_top = get_post_meta( $post->ID, $this->top_box_option, true );
 $is_bottom = get_post_meta( $post->ID, $this->bottom_box_option, true );
 $post_reviews = get_post_meta( $post->ID, $this->reviews_option, true );
 $review_summary = get_post_meta( $post->ID, $this->review_summary_option, true );
 $review_title = get_post_meta( $post->ID, $this->review_title_option, true );
...
<p>
	<label for="<?php echo $this->plugin_slug; ?>-post-visibility">
		<input type="checkbox" id="<?php echo $this->plugin_slug; ?>-post-visibility" name="<?php echo $this->visibility_option; ?>" value="1" <?php checked( $is_visible, 1 ); ?>><?php _e( 'Turn On the Review feature', $this->plugin_slug ) ?>
	</label>
</p>
...
<div class="simple-review-table">
	...
	<div class="simple-review-section">
		...
		<p class="meta-options">
			<label for="<?php echo $this->plugin_slug; ?>-post-top" class="selectit">
				<input type="checkbox" id="<?php echo $this->plugin_slug; ?>-post-top" name="<?php echo $this->top_box_option; ?>" value="1" <?php checked( $is_top, 1 ); ?>><?php _e( 'Top of the post', $this->plugin_slug ) ?>
			</label>
			<br>
			<label for="<?php echo $this->plugin_slug; ?>-post-bottom" class="selectit">
				<input type="checkbox" id="<?php echo $this->plugin_slug; ?>-post-bottom" name="<?php echo $this->bottom_box_option; ?>" value="1" <?php checked( $is_bottom, 1 ); ?>><?php _e( 'Bottom of the post', $this->plugin_slug ) ?>
			</label>
		</p><!-- .meta-options -->
	</div><!-- .simple-review -->
	...
	<div class="simple-review-section">
		...
		<p><input type="text" class="widefat" name="<?php echo $this->review_title_option; ?>" value="<?php echo esc_attr( $review_title ); ?>"></p>
	</div><!-- .simple-review -->

	<div class="simple-review-section">
		<p class="label"><?php _e( 'Review Summary', $this->plugin_slug ) ?></p>
		<p><textarea class="widefat" name="<?php echo $this->review_summary_option; ?>" rows="6"><?php echo esc_html( $review_summary ); ?></textarea></p>
	</div><!-- .simple-review -->
	...
	<table class="widefat">
		...
		<?php if( !empty( $post_reviews ) ): ?>
			...
			<tr class="review-row">
				...
				<td width="60%">
					<input type="text" class="widefat text" name="<?php echo $this->reviews_option; ?>[<?php echo esc_attr( $key ); ?>][label]" value="<?php echo esc_attr( $value[label] ); ?>">
				</td>
				<td width="40%">
					<select class="select widefat" name="<?php echo $this->reviews_option; ?>[<?php echo esc_attr( $key ); ?>][score]">
		...
		<?php endif; ?>
			...
			<tr class="review-clone">
				<td class="order">1</td>
				<td width="60%">
					<input type="text" class="widefat text" name="<?php echo $this->reviews_option; ?>[dummyindex][label]">
				</td>
				<td width="40%">
					<select class="select widefat" name="<?php echo $this->reviews_option; ?>[dummyindex][score]">
